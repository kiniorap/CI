<div class="card">
    <h5 class="card-header">Agregar Pedido<a href="<?= base_url()?>marcas" class="btn btn-secondary float-right">ATRAS</a></h5>
    <div class="card-body">
        <div class="container">
            <div class="row">
                <div class="col-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <form id="frmCargarModelos" action="<?= base_url()?>pedidos/agregar" method="POST">    
...
<form action="<?= base_url()?>pedidos/guardar/" method="post"> 
    ...
    <input type="hidden" value="<?=$this->objDatosEnvio->nombre?>" name="strNombre">
    <input type="hidden" value="<?=$this->objDatosEnvio->fechaEntrega?>" name="strFechaEntrega">
    <input type="hidden" value="<?=$this->objDatosEnvio->direccion?>" name="strDireccion">
    <input type="hidden" value="<?=$this->objDatosEnvio->costoEnvio?>" name="dblCostoEnvio">
    <input type="hidden" value="<?=$this->objDatosEnvio->estatus?>" name="intEstatus">
